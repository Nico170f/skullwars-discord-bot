...
exports.run = async(client, message, args) => { //eslint-no-unused-vars
  ...
  .setDescription(`Your staff ranking can't lock the Discord!`)
  .setColor(T.red)
  ...
  .setColor(T.blank)
  .setDescription(`The Discord has been locked!`)
  ...
  .setColor(T.red)
  .setDescription(`${message.author} locked ${message.channel}. (${message.channel.name})`)
